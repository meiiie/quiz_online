...
export default function Header() {
  ...
  return (
    <header
      className={`fixed inset-x-4 top-4 z-50 mx-auto flex max-w-7xl justify-center rounded-2xl border border-transparent px-4 py-3 transition-all duration-300 ${
        isScrolled || isMobileMenuOpen
          ? "border-blue-200/30 bg-white/95 shadow-xl shadow-blue-500/10 backdrop-blur-md"
          : "bg-white/0"
      }`}
    >
